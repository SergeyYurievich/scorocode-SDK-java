...
public class MessagingManager {
    ...
    public void send(final SCCallback<Boolean> callback, Message msg, MessageType type, Query query) {
        MessageService service = SCServiceFactory.create(MessageService.class);
        final MessagingRequestEntity messagingRequestEntity = new MessagingRequestEntity(msg);
        messagingRequestEntity.setQuery(query);
