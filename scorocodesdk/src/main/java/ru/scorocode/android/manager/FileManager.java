...
public class FileManager {
    ...
    public void upload(final SCCallback<String> callback, String acc, String sess, String coll, String doc, String field, String content) {

        FileService service = SCServiceFactory.create(FileService.class);
        final FileUploadRequestEntity fileUploadRequestEntity = new FileUploadRequestEntity(acc, sess, coll, doc, field, content);
    ...
    public void getFile(final SCCallback<InputStream> callback, String app, String coll, String field, String file) {

        FileService service = SCServiceFactory.create(FileService.class);

        Call<ResponseBody> call = service.getfile(app, coll, field, file);
