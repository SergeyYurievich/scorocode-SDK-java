...
public class ScriptManager {
    ...
    public void scripts(final SCCallback<Boolean> callback, String sessionId, String accessKey, String scriptId, String[] pool) {
        ScriptService service = SCServiceFactory.create(ScriptService.class);
        final ScriptRequestEntity scriptRequestEntity = new ScriptRequestEntity(sessionId, accessKey, scriptId, pool);
    ...
    public void stats(final SCCallback<Boolean> callback, String accessKey) {
        ScriptService service = SCServiceFactory.create(ScriptService.class);
        final StatRequestEntity statRequestEntity = new StatRequestEntity(accessKey);
